...
insert into `snake_user`(`id`,`username`,`password`,`loginnum`,`last_login_ip`,`last_login_time`,`real_name`,`status`,`typeid`) values('1','admin','21232f297a57a5a743894a0e4a801fc3','42','127.0.0.1','1477404903','admin','1','1');
...
insert into `snake_user`(`id`,`username`,`password`,`loginnum`,`last_login_ip`,`last_login_time`,`real_name`,`status`,`typeid`) values('8','lisi123','c3cb6d12c40908943b64bc0681af47db','13','127.0.0.1','1477403480','lisi','1','3');
